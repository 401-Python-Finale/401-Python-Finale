    ...
    return (
        <div className=" m-8 flex justify-evenly">
            <form onSubmit="submit" className="">
                    <textarea rows = "5" cols = "60" name="post" id="post" className="justify-center h-screen w-96 bg-gray-200 pl-3.5 text-sm overflow-scroll" placeholder="What's On Your Mind?"></textarea>
